...
Private Const WorkaroundTableSuffix As String = "_TableCQW"
...
Public Sub AddWorkaroundForCorruptedQueryIssue()
    ...
    With CurrentDb
        ...
        For Each tableDef In .TableDefs
            ...
            If Not EndsWith(tableDef.Name, WorkaroundTableSuffix) And Not isSystemTable And Not tableDef.Name = "USysRibbons" Then
